/* ============================================================================
   ...
   2026-09-11: wetland strip. A 664x200 illustrated continuation of the plan
   (sv-map-wetland.svg, generated by src/wetland-strip-gen.js) sits in
   .site-plan_map-extension, a sibling AFTER .site-plan_map-canvas, so nothing
   inside the canvas moves. The zoom module writes --sv-zoom to it too, and the
   reveal fades it in with the context labels. CSS lives in the site-plan embed.
...
(function () {
  ...
  /* the wetland strip under the plan (a sibling of the canvas) carries the
     same width expression, so it gets the same --sv-zoom and pans with it */
  function extension() { return document.querySelector('.site-plan_map-extension'); }
  function setZoomVar(v) {
    canvas.style.setProperty('--sv-zoom', v);
    var ext = extension();
    if (ext) ext.style.setProperty('--sv-zoom', v);
  }
...
(function () {
  ...
  var SEL = {
    ...
    late: ['.site-plan_badges', '.site-plan_zoom', '.site-plan_context', '.site-plan_map-extension']
  };
  ...
  function css() {
    ...
    s.textContent =
      ...
      'html.' + CLASS + ' .site-plan_badges,html.' + CLASS + ' .site-plan_zoom,html.' + CLASS + ' .site-plan_context,html.' + CLASS + ' .site-plan_map-extension{opacity:0}' +
      ...
      'html.sv-reveal-go .site-plan_badges,html.sv-reveal-go .site-plan_zoom,html.sv-reveal-go .site-plan_context,html.sv-reveal-go .site-plan_map-extension' +
      ...
      'html.sv-reveal-go .site-plan_context,html.sv-reveal-go .site-plan_map-extension{transition-delay:' + (T.stagger * 2) + 'ms}' +
